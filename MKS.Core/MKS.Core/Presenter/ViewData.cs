...
namespace MKS.Core.Presentation
{
    ...
    public class ViewData
    {
        ...
        /// </summary>
        public Tuple<string, ProcessResults> BusinessValidation { get; set; }
        ...
        /// </summary>
        //OLD public Tuple<string, List<ReturnMessage>, List<LinkObjectView>> IntegrityValidationErrors { get; set; }
        public Tuple<string, RuleResults> IntegrityValidationErrors { get; set; }

        /// <summary>
        ///     Contient l'ensemble des erreurs de réservation
        /// </summary>
        public Tuple<string, string, Severity> ReservationMessages { get; set; }
