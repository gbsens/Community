...
namespace MJQ.Core
{
    ...
    public static class Reflect<TTarget>
    {
        ...
        private static MethodInfo GetMethodInfo(Expression method)
        {
            ...
            if (lambda == null)
                throw new ArgumentException(LibraryResources.Reflect_GetMethodInfo_Not_a_lambda_expression, "method");
            if (lambda.Body.NodeType != ExpressionType.Call)
                throw new ArgumentException(LibraryResources.Reflect_GetMethodInfo_Not_a_method_call, "method");
        ...
        private static MemberInfo GetMemberInfo(Expression member)
        {
            ...
            if (lambda == null)
                throw new ArgumentException(LibraryResources.Reflect_GetMethodInfo_Not_a_lambda_expression, "member");
            ...
            if (memberExpr == null)
                throw new ArgumentException(LibraryResources.Reflect_GetMemberInfo_Not_a_member_access, "member");
