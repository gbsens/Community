...
namespace MKS.Library.LinqKit
{
	...
	public static class Extensions
	{
		...
		public static IQueryable<T> SortBy<T>(this IQueryable<T> source, string propertyName, string sortDirection)
		{
			...
			string methodName = sortDirection.Equals("ASC") ? "OrderBy" : "OrderByDescending";
        ...
        public static IQueryable<T> ThenBy<T>(this IQueryable<T> source, string propertyName, string sortDirection)
        {
            if (source == null)
            {
                throw new ArgumentNullException("source");
            ...
            MemberExpression property = Expression.Property(parameter, propertyName);
            LambdaExpression lambda = Expression.Lambda(property, parameter);
            string methodName = sortDirection.Equals("ASC") ? "ThenBy" : "ThenByDescending";
